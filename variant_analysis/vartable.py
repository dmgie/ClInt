...
if __name__ == "__main__":
    ...
    parser.add_argument('--dna_startswith', required=False, help='OPTIONAL: specify dna naming scheme', default="haplotype_dedup_snc")
    ...
    variant_positions = search_vcf_position_matches(dir_dict, dna_startswith, rna_startswith)
    ...
    with open(f'./{dir_dict["out"]}/output.tsv', 'wt') as out_file:
        ...
        tsv_writer.writerow(['Gene_ID', "Gene_Name", 'Start', 'End', 'Variant_Position', 'Extension', 'REF', "DNA_ALT", "RNA_ALT", "Counts_Alt", "Counts_TPM"])
        ...
        create_agreement(agreement, dna_count, rna_count, matching_count, dir_dict["out"])
